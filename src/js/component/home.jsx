  ...
  return (
    <div class="image-back">
      <div id="container" class="container-fluid post-it">
        <div class="try">
          <h1 class="fontTodo">Todo List<button type="button"
            class="nuclear btn btn-outline-warning" onClick={() => deleteAllTask()}><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-radioactive" viewBox="0 0 16 16">
